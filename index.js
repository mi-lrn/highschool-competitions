const data = [
     ...
     { title: "Math", description: "Focuses on the study of numbers, shapes, patterns, and structures, using logical reasoning and quantitative methods to solve problems and describe relationships", competitions: ["American Invitiational Mathematics Examination (AIME)", "American Mathematics Competition 10 (AMC 10)", "American Mathematics Competition 12 (AMC 12)","COMAP's High School Mathematical Contest in Modeling (HiMCM)", "Math Kangaroo Competition", "Math League", "Purple Comet! Math Meet!"] },
