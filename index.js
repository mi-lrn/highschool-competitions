const data = [
     ...
     { title: "English", description: "Focuses on language, literature, and composition, specifically reading and writing to understand and communicate ideas effectively.", competitions: ["AFSA National High School Essay Contest", "National Scholastic Art & Writing Awards", "Princeton Leonard L. Milberg ’53 High School Poetry Prize", "Princeton University Ten-Minute Play Contest", "SPJ/JEA High School Essay Contest", "The Bennington Young Writers Awards"] },
     { title: "History", description: "Focuses on the study of past events, people, and societies to understand their impact on the present and shape future decisions.", competitions: ["Profile in Courage Essay Contest by JFK Presidential Library"] },
