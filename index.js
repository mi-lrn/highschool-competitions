const data = [
     { title: "Biology", description: "Focuses on living organisms, their structures, functions, interactions, and the processes that sustain life.", competitions: ["BioGENEius Challenge: Conduct innovative research in biotechnology, covering fields like healthcare, agriculture, and environmental sustainability. Provides students with opportunities to present their research to industry leaders and compete at national and international levels. Open to grades 9-12 https://biotechinstitute.org/biogeneius/", "Brain Bee", "International Genetically Engineered Machine (iGEM)", "USA Biology Olympiad (USABO)"] },
